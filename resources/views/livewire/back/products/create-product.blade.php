                        ...
                        <form wire:submit.prevent="store" autocomplete="off">
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea placeholder="Short description for the product" class="form-control @error('description') is-invalid @enderror" wire:model="description"></textarea>
                                    @error('description')
                                    <div class="invalid-feedback">
                                        <strong>{{ $message }}</strong>
                                    </div>
                                ...
                                <div class="form-group mb-0" wire:ignore>
                                    <label>Details: </label>
                                    <textarea id="create-editor-details" placeholder="Product details" class="form-control @error('details') is-invalid @enderror" wire:model="details"></textarea>
                                </div>
                                @error('details')
                                ...
                                <div class="form-group">
                                    <div class="form-row align-items-end">
                                        ...
                                        <div class="col-2">
                                            <button type="button" class="btn btn-info w-100" {{!$attr ? 'disabled' : ''}}  wire:click.prevent="add"><i class="feather icon-plus"></i> Add</button>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" placeholder="Product Image" class="custom-file-input @error('image') is-invalid @enderror" wire:model="image">
                                        ...
                                        @if($image)
                                            <div style="width: 70px" class="mt-1">
                                                <img src="{{$image->temporaryUrl()}}" class="img-thumbnail w-100 mb-3" alt="">
                                            </div>
                                        @endif
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="custom-file">
                                        <input type="file" multiple placeholder="Product Images" class="custom-file-input @error('images') is-invalid @enderror" wire:model="images">
                                        <label class="custom-file-label" for="inputGroupFile01">Choose file</label>
                                        @error('images')
                                        <div class="invalid-feedback">
                                            <strong>{{ $message }}</strong>
                                                ...
                                                <div class="d-flex justify-content-start">
                                                    @foreach($images as $image)
                                                        <div style="width: 70px" class="mr-50">
                                                            <img src="{{$image->temporaryUrl()}}" class="img-thumbnail w-100 mr-50" alt="">
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div>
...
@push('scripts')
    ...
    <script>
        $(document).ready(function() {
            $('#create-editor-details').summernote({
                placeholder: "Product Details Her...",
                minHeight: 200,
                tabSize: 2,
                callbacks: {
