    ...
    <form wire:submit.prevent="update" autocomplete="off">
        <div class="modal-body">
            ...
            <div class="form-group" wire:ignore>
                ...
                <input type="text" id="edit_expiry_date" placeholder="Expiry Date" class="form-control  @error('expiry_date') is-invalid @enderror" wire:model="expiry_date">
                @error('expiry_date')
                <div class="invalid-feedback">
                    <strong>{{ $message }}</strong>
                </div>
